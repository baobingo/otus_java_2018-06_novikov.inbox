 ...
 * Created by tully.
 */
public class CacheEngineImplStrongRef<K, V> implements CacheEngine<K, V> {
    ...
    CacheEngineImplStrongRef(int maxElements, long lifeTimeMs, long idleTimeMs, boolean isEternal) {
